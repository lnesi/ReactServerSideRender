...
exports.default = [_extends({}, _App2.default, {
	routes: [_extends({}, _HomePage2.default, { path: "/", exact: true }), _extends({}, _UsersListPage2.default, { path: "/users" }), _extends({}, _AdminsListPage2.default, { path: "/admins" }), _extends({}, _NotFoundPage2.default)]
})];
...
exports.default = function (request, store, context) {
	var content = (0, _server.renderToString)(_react2.default.createElement(
		_reactRedux.Provider,
		{ store: store },
		_react2.default.createElement(
			_reactRouterDom.StaticRouter,
			{ location: request.path, context: context },
			_react2.default.createElement(
				"div",
				null,
